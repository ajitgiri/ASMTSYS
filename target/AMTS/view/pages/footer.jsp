    ...
    <footer><p>&copy; Company 2014</p></footer>
	  ...
	  <div class="utility">
	      <button class="btn btn-default toggle-utility">
    	  	...
    	  	<i class="fa fa-angle-double-right fa-lg" style="display: none"></i>
    	  </button>
...
<link href="<%=contextPath%>/view/css/dataTables.css" rel="stylesheet">
	...
	<script type="text/javascript"  src="<%=contextPath%>/view/js/respond.js"></script>
	 --%>
      <script>
          ...
          $(function () {
              ...
              function layout() {
                  ...
                  $(".page-content").css("min-height", vcontainer - vheader - vfooter - vpagetitle);
      ...
      <div class="modal fade" id="myModal" data-toggle="modal" data-target=".bs-example-modal-lg">
